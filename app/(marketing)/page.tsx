    ...
    <>
      ...
      >
        <div className="text-center space-y-6 max-w-[58rem] mx-auto">
          ...
          <p className="text-muted-foreground sm:text-lg sm:leading-7">
            ...
            Next.jsAPPRouterやcontetlayerを使用してマークダウン形式でブログ投稿ができます。
          </p>
        </div>
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 mx-auto">
          <div className="bg-background border p-2 rounded-lg">
            <div className="flex flex-col justify-between p-6 md:h-[160px]">
              <svg
          ...
          <div className="bg-background border p-2 rounded-lg">
            <div className="flex flex-col justify-between p-6 md:h-[160px]">
              ...
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground">Reactを使用</p>
              </div>
            </div>
          </div>
          <div className="bg-background border p-2 rounded-lg">
            <div className="flex flex-col justify-between p-6 md:h-[160px]">
              ...
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground">PlanetScale技術を使用</p>
              </div>
            </div>
          </div>
          <div className="bg-background border p-2 rounded-lg">
            <div className="flex flex-col justify-between p-6 md:h-[160px]">
              ...
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground">TailwindCSSを使用</p>
              </div>
            </div>
          </div>{" "}
          <div className="bg-background border p-2 rounded-lg">
        ...
        <div className="mx-auto md:max-w-[58rem] text-center">
          <p className="text-muted-foreground sm:text-lg sm:leading-7">
            PostWriterはログインするとブログ投稿ができるようになります
          </p>
        </div>
      </section>
      ...
      >
        <div className="max-w-[58rem] mx-auto text-center flex flex-col gap-4">
          ...
          <p className="text-muted-foreground sm:text-lg sm:leading-7">
            もしもWebサービスが気に入った場合には下記XからDMでご連絡下さい。
            <br />
            お仕事のご連絡お待ちしています。
          </p>
          <Link
